...
- `MEMBER_AUDIT_LOG_PROPOSAL.md` - Original proposal and design
- `AUDIT_LOG_USER_EXPERIENCE.md` - User experience by role
- `AUDIT_LOG_IMPLEMENTATION_PLAN.md` - Full implementation plan
