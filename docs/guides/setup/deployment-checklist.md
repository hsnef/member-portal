...
- Email addresses: dev-mp+test*@hsnef.org
...
- dev-mp+testlifetime@hsnef.org (Member - Lifetime)
- dev-mp+testannual@hsnef.org (Member - Annual)
- dev-mp+testcommunity@hsnef.org (Member - Community)
...
**Workaround:** Use email template in `../features/member-self-registration-guide.md`
...
| Document | Purpose |
|----------|---------|
| **`../features/registration-flow-guide.md`** | Complete auth & registration flows |
| **`../features/member-self-registration-guide.md`** | Self-registration system details |
