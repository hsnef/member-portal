...
2. Add each variable from [environment-variables.md](./environment-variables.md)
3. For each variable:
...
**Required Variables** (see [environment-variables.md](./environment-variables.md) for full list):
