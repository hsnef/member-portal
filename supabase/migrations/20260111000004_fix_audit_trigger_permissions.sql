-- ============================================================================
-- Fix Audit Trigger Permissions
-- The log_member_creation and log_member_changes functions need SECURITY DEFINER
-- to access auth.users table
-- ============================================================================

-- Drop existing triggers first
DROP TRIGGER IF EXISTS trigger_log_member_creation ON members;
DROP TRIGGER IF EXISTS trigger_log_member_changes ON members;

-- Recreate log_member_creation with SECURITY DEFINER
...
-- Recreate log_member_changes with SECURITY DEFINER
...
BEGIN
  ...
  -- Only insert if there were changes (excluding membership_id which is handled separately)
