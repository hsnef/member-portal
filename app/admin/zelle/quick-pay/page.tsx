              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-transparent"
                  >
                    Cancel
                  </button>
                  {activeRequest.status === 'member_confirmed' && (
                ...
                <button
                  ...
                  className="w-full py-2 border-2 border-dashed border-gray-300 text-gray-600 rounded-md hover:border-gray-400 hover:bg-transparent"
                >
