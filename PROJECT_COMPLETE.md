...
1. **PAYMENTS_SETUP.md** - Payment system setup guide
2. **EVENTS_SYSTEM.md** - Events management guide
3. **REQUESTS_INVOICES_SYSTEM.md** - Requests/invoices guide
4. **PROJECT_COMPLETE.md** - This file (project overview)
5. **README.md** - General project information
6. **SupabaseA-auth_setup.md** - Supabase auth configuration
